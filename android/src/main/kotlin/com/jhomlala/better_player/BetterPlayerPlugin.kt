...
class BetterPlayerPlugin : FlutterPlugin, ActivityAware, MethodCallHandler {
    ...
    private fun continueNotification(betterPlayer: BetterPlayer) {
      try {
          val textureId = getTextureId(betterPlayer)
          if (textureId != null) {
              val dataSource = dataSources[textureId]
    ...
    companion object {
        ...
        private const val CONTINUE_NOTIFICATION_METHOD = "continueNotification"
        private const val REMOVE_NOTIFICATION_METHOD = "removeNotification"
